                ...
                <form action="{{route('barang.update', $barang->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="choices form-select" name="id_kategori_barang">
                            ...
                            <option value="{{$kategori_barang->id}}" {{$barang->id_kategori_barang == $kategori_barang->id ? 'selected' : ''}}>{{$kategori_barang->nama}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="basicInput" name="nama" placeholder="Masukan Nama" value="{{$barang->nama}}">
