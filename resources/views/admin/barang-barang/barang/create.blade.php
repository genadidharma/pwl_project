                ...
                <form action="{{route('barang.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="number-separator" class="form-control @error('harga_satuan') is-invalid @enderror" placeholder="Masukan Harga Satuan" id="basicInput" name="harga_satuan" value="{{old('harga_satuan')}}">
