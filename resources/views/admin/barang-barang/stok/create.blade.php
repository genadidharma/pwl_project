            ...
            <div class="card-body">
                <form action="{{route('stok.store')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="number-separator" class="form-control @error('jumlah') is-invalid @enderror" id="basicInput" name="jumlah" placeholder="Masukan Jumlah" value="{{old('jumlah')}}">
