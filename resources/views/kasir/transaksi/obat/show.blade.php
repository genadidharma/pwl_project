        ...
        <div class="col-xl-8 col-md-12">
            <div class="card">
                <div class="card-header d-flex align-items-between">
                    ...
                    <a href="{{route('transaksi.obat.show',['obat'=>$transaksi->id,'print'=>'true'])}}" class="btn btn-danger ms-auto m-3"> <i class="icon-mid bi-file-earmark-arrow-down"></i> Download PDF</a>
                </div>
                <div class="card-body">
